...
public class ConnectorTest {
    ...
    public void whenChangeStatusThenChanged() {
        ...
        int userId = connector.addUser(user);
        user.setId(userId);
        Car car = new Car("type1", "brand", "model", 1, 2020, "desc", 123);
        car.setUser(user);
    ...
    public void whenAddCarThenAdded() {
        ...
        int userId = connector.addUser(user);
        user.setId(userId);
        Car car = new Car("type1", "brand", "model", 2, 2020, "desc", 123);
        car.setUser(user);
        int carId = connector.addCar(car);
        EntityManager em = emf.createEntityManager();
        EntityTransaction tx = em.getTransaction();
    ...
    public void whenCarsByUserThenCarsList() {
        ...
        user.setId(userId);
        user2.setId(user2Id);
        Car car = new Car("type1", "brand", "model", 2, 2020, "desc", 2);
        car.setUser(user);
        Car car2 = new Car("type2", "brand2", "model2", 1, 1999, "desc2", 3);
        car2.setUser(user2);
    ...
    public void whenAllCarsThenAll() {
        ...
        user.setId(userId);
        user2.setId(user2Id);
        Car car = new Car("type1", "brand", "model", 23, 2020, "desc", 111);
        car.setUser(user);
        Car car2 = new Car("type2", "brand2", "model2", 32, 1999, "desc2", 122);
        car2.setUser(user2);
        connector.addCar(car);
        connector.addCar(car2);
    ...
    public void whenAllBrandsThenAll() {
        ...
        user.setId(userId);
        user2.setId(user2Id);
        Car car = new Car("type1", "brand", "model", 101, 2020, "desc", 123);
        car.setUser(user);
        Car car2 = new Car("type2", "brand2", "model2", 102, 2000, "desc2", 321);
        car2.setUser(user2);
        connector.addCar(car);
        connector.addCar(car2);
    ...
    public void whenDayFilterThenTodayTickets() {
        ...
        user.setId(userId);
        user2.setId(user2Id);
        Car car = new Car("type1", "brand", "model", 100, 2020, "desc", 1);
        car.setUser(user);
        Car car2 = new Car("type2", "brand2", "model2", 102, 2222, "desc2", 2);
    ...
    public void whenPhotoFilterThenOnlyWithPhoto() {
        ...
        user.setId(userId);
        user2.setId(user2Id);
        Car car = new Car("type1", "brand", "model", 1, 2020, "desc", 1);
        car.setUser(user);
        Car car2 = new Car("type2", "brand2", "model2", 2, 2222, "desc2", 2);
        car2.setUser(user2);
    ...
    public void whenBrandFilterThenOnlyOne() {
        ...
        user.setId(userId);
        user2.setId(user2Id);
        Car car = new Car("type1", "brand", "model", 100, 2020, "desc", 10000);
        car.setUser(user);
    ...
    public void whenAllFiltersThenThird() {
        ...
        user.setId(userId);
        user2.setId(user2Id);
        Car car = new Car("type1", "brand1", "model1", 1, 2021, "desc", 1);
        car.setUser(user);
        Car car2 = new Car("type2", "brand2", "model2", 2, 2022, "desc2", 2);
        car2.setUser(user2);
        Car car3 = new Car("type3", "brand2", "model3", 3, 2023, "desc3", 3);
        car3.setUser(user2);
        long yesterday = System.currentTimeMillis() - 1000 * 60 * 60 * 24;
        GregorianCalendar cal = new GregorianCalendar();
        cal.setTimeInMillis(yesterday);
